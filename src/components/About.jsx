...
function About() {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Abdi Alamsyah - About</title>
        </Helmet>
      </HelmetProvider>
      <FsLightbox
        toggler={lightboxController.toggler}
      ...
      <Container fluid className="about-wrapper">
        ...
        <div className="about-right animate__animated animate__fadeIn animate__slower py-3">
          <p>
            Hi, I'm Abdi Alamsyah, a student studying Informatics Engineering at
            Budi Darma University. I have a strong interest in web programming. Specifically, I use a combination of technologies called the MERN stack (MongoDB, Express.js, React.js,
            Node.js).
          </p>
